...
Uses the OpenAI API client to run a model against the environment. Reads API credentials from environment variables (OPENAI\_API\_KEY). Produces a reproducible baseline score on all 3 tasks.
