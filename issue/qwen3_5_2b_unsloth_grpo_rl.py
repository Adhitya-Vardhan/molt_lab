...
try:
    import openenv  # noqa: F401 — real openenv-core available
except ImportError:
    import openenv_shim  # noqa: F401 — register lightweight stubs for Colab
...
RUN_EVAL = os.getenv("RUN_EVAL", "0").lower() in {"1", "true", "yes"}
